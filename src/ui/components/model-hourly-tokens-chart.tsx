...
export function ModelHourlyTokensChart({
  ...
  const filteredRows = React.useMemo(() => {
    ...
    if (!lastPoint) return [];
    const referenceDate = new Date(lastPoint.hour);
  ...
  return (
    <section className="rounded-xl border bg-background">
      <div className="flex flex-wrap items-center gap-2 px-3 py-4 sm:px-5">
      ...
      <div className="px-2 py-4 sm:px-4">
        {isEmpty ? (
          <EmptyState className="h-80 min-h-0 rounded-lg border border-dashed" />
        ) : (
